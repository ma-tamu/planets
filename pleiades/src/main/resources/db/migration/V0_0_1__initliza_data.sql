...
INSERT INTO `oauth_client` (`id`, `name`, `client_id`, `client_secret`, `created_at`, `created_by`, `updated_at`, `update_by`, `is_deleted`)
VALUES
('5e7abd95663011ec8a0b0242ac120003','mars','34a10a88cbc2cfab10f4262e09439efec7e76a34e1b28687f0a19d43d3e76f4d','c103fb40ee6d955024b7319b29fc4ad44e8c4c4a3c160b6a6075c00b39bd1991',now(),'NULL',now(),'NULL', 0);

INSERT INTO `oauth_client_grant_type` (`id`, `oauth_client_id`, `grant_type_id`)
VALUES
  (replace(uuid(), '-', ''), '5e7abd95663011ec8a0b0242ac120003', '1b6a0d2a65f911ec8a0b0242ac120003'),
