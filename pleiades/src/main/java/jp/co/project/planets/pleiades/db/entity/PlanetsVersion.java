 ...
 * 
 */
@Entity(listener = PlanetsVersionListener.class )
@Table(name = "planets_version")
public class PlanetsVersion extends AbstractPlanetsVersion implements java.io.Serializable {
