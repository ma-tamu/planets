 ...
 * 
 */
public class RedirectUriDaoTest {
    ...
    public void testSelectByClientId(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/jp/co/project/planets/pleiades/db/dao/RedirectUriDao/selectByClientId.sql", dialect);
        execute(sqlFile);
    }
