 ...
 * 
 */
public class CompanyBaseDaoTest {
    ...
    public void testSelectById(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/jp/co/project/planets/pleiades/db/dao/base/CompanyBaseDao/selectById.sql", dialect);
        execute(sqlFile);
    }
