...
public class OAuthClientDaoTest {
    ...
    public void testSelectByClientId(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/jp/co/project/planets/pleiades/db/dao/OAuthClientDao/selectByClientId.sql", dialect);
        execute(sqlFile);
    }
