 ...
 * 
 */
public class Oauth2AuthorizationConsentBaseDaoTest {
    ...
    public void testSelectById(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/jp/co/project/planets/pleiades/db/dao/base/Oauth2AuthorizationConsentBaseDao/selectById.sql", dialect);
        execute(sqlFile);
    }
