 ...
 * 
 */
public class OfficeBaseDaoTest {
    ...
    public void testSelectById(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/jp/co/project/planets/pleiades/db/dao/base/OfficeBaseDao/selectById.sql", dialect);
        execute(sqlFile);
    }
