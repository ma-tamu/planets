...
public class PermissionDaoTest {
     ...
     */
    @Test
    public void testSelectGrantedPermissionByUserId(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/jp/co/project/planets/pleiades/db/dao/PermissionDao/selectGrantedPermissionByUserId.sql", dialect);
        execute(sqlFile);
    }
