...
public class UserDaoTest {
    ...
    public void testSelectByLoginId(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/jp/co/project/planets/pleiades/db/dao/base/UserDao/selectByLoginId.sql", dialect);
        execute(sqlFile);
    }
