 ...
 * 
 */
public class OauthClientConsentDaoTest {
     ...
     */
    @Test
    public void testSelectConsentClientIdByUserId(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/jp/co/project/planets/pleiades/db/dao/OauthClientConsentDao/selectConsentClientIdByUserId.sql", dialect);
        execute(sqlFile);
    }
