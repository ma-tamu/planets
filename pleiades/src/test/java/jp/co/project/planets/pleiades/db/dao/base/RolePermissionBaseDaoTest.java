 ...
 * 
 */
public class RolePermissionBaseDaoTest {
    ...
    public void testSelectById(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/jp/co/project/planets/pleiades/db/dao/base/RolePermissionBaseDao/selectById.sql", dialect);
        execute(sqlFile);
    }
