 ...
 * 
 */
public class OauthClientRedirectUrlDaoTest {
     ...
     */
    @Test
    public void testSelectByOAuthClientId(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/jp/co/project/planets/pleiades/db/dao/OauthClientRedirectUrlDao/selectByOAuthClientId.sql", dialect);
        execute(sqlFile);
    }
