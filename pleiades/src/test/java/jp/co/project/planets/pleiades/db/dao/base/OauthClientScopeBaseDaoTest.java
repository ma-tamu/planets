 ...
 * 
 */
public class OauthClientScopeBaseDaoTest {
    ...
    public void testSelectById(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/jp/co/project/planets/pleiades/db/dao/base/OauthClientScopeBaseDao/selectById.sql", dialect);
        execute(sqlFile);
    }
